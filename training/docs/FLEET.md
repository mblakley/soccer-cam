...
- **FORTNITE-OP has a REALLY fast CPU (Ryzen 7 5800X, 16 threads) — approved as a
  ...
  Setup needed on first use: uv missing under the training user. Drives: C: 24GB free (system, stay lean); **D: 'Games' SSD 222GB free = staging/work drive** (it's the gaming drive — keep >=100GB free); F: 'GameplayVideo' HDD 231GB free (bulk video staging, jared's recordings — leave headroom).
