...
@dataclass(frozen=True)
class ServerConfig:
    hostname: str = ""  # Set in config.toml
    ip: str = ""  # Set in config.toml
    share_training: str = ""  # Set in config.toml
    share_video: str = ""  # Set in config.toml
...
class WorkerConfig:
    ...
    hostname: str = ""
    capabilities: list[str] = field(default_factory=list)
    server_share: str = ""  # Set in worker_config.toml
