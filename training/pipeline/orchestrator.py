...
def action_check_fortnite_labeling(state: dict) -> dict:
    ...
    if mgr.stage_video("FORTNITE-OP", next_game, video_paths):
        ...
        mgr.remote_exec("FORTNITE-OP", f"""
            ...
            @"
C:\\Python313\\python.exe -u C:\\soccer-cam-label\\label_job.py --video-dir "D:\\labeling\\{next_game}" --game-id "{next_game}" --model "C:\\soccer-cam-label\\models\\balldet_fp16.onnx" --db "D:\\labeling\\manifest.db" > D:\\labeling\\label_log.txt 2>&1
