...
# Verify access
test_path = os.path.join(share, "training_data", "ball_dataset_v1", "images", "val")
...
if "4070" in gpu_name:
    model_name, run_name, batch = "yolo11s.pt", "ball_small", 16
elif "3060" in gpu_name:
    model_name, run_name, batch = "yolo11n.pt", "ball_nano_3060", 16
else:
    model_name, run_name, batch = "yolo11n.pt", "ball_nano", 8
