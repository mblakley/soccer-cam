...
class TestDownloadProcessor:
    ...
    @pytest.mark.asyncio
    async def test_download_processor_initialization(self, temp_storage, mock_config, mock_camera):
    ...
    async def test_successful_download(self, mock_directory_state, temp_storage, mock_config, mock_camera):
        ...
        mock_camera.download_file.assert_called_once_with(
            file_path='/test.dav',
            local_path='/test/group/test.dav'
        )
    ...
    @pytest.mark.asyncio
    @patch('video_grouper.task_processors.download_processor.DirectoryState')
    async def test_failed_download(self, mock_directory_state, temp_storage, mock_config, mock_camera):
    ...
    @pytest.mark.asyncio
    @patch('video_grouper.task_processors.download_processor.DirectoryState')
    async def test_download_exception_handling(self, mock_directory_state, temp_storage, mock_config, mock_camera):
    ...
    @pytest.mark.asyncio
    @patch('video_grouper.task_processors.download_processor.DirectoryState')
    async def test_download_without_video_processor(self, mock_directory_state, temp_storage, mock_config, mock_camera):
