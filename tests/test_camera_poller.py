...
class TestCameraPoller:
    ...
    @pytest.mark.asyncio
    async def test_camera_poller_initialization(self, temp_storage, mock_config, mock_camera):
    ...
    @pytest.mark.asyncio
    async def test_discover_work_camera_unavailable(self, temp_storage, mock_config, mock_camera):
    ...
    @pytest.mark.asyncio
    async def test_sync_files_from_camera_no_files(self, temp_storage, mock_config, mock_camera):
    ...
    @pytest.mark.asyncio
    async def test_sync_files_from_camera_with_files(self, temp_storage, mock_config, mock_camera):
    ...
    @pytest.mark.asyncio
    async def test_connected_timeframe_filtering(self, temp_storage, mock_config, mock_camera):
    ...
    async def test_skip_existing_files(self, mock_find_group, mock_directory_state, temp_storage, mock_config, mock_camera):
    ...
    def test_find_group_directory_existing_group(self, mock_exists, mock_directory_state, temp_storage):
        ...
        group_dir = find_group_directory(file_start_time, temp_storage, [existing_group])
