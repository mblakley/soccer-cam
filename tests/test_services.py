...
from video_grouper.task_processors.services import (
    ...
    MatchInfoService, CleanupService
)
...
class TestTeamSnapService:
    ...
    def teamsnap_config(self):
        ...
        return TeamSnapConfig(enabled=True, team_id='test_team_id', my_team_name='Test Team')
    ...
    def test_init_disabled(self):
        ...
        config = TeamSnapConfig(enabled=False, team_id='test_team_id', my_team_name='Test Team')
...
class TestPlayMetricsService:
    ...
    def playmetrics_config(self):
        """Create test configuration."""
        return PlayMetricsConfig(enabled=True, username='test_user', password='test_pass', team_name="Test Team")
...
class TestNtfyService:
    ...
    def ntfy_config(self):
        """Create test configuration."""
        return NtfyConfig(enabled=True, server_url="http://localhost:8080", topic="test-topic")
...
class TestCleanupService:
    ...
    def test_cleanup_dav_files(self, mock_dir_state, tmp_path):
        ...
        with patch('video_grouper.task_processors.services.cleanup_service.DirectoryState.save'):
            with patch('os.remove') as mock_remove:
                ...
                dir_state_instance.update_dir_state.assert_called_once_with({'status': 'autocam_complete_dav_files_deleted'})
    ...
    def test_should_cleanup_dav_files(self, mock_dir_state, tmp_path):
        ...
        with patch('video_grouper.task_processors.services.cleanup_service.DirectoryState', return_value=dir_state_instance):
