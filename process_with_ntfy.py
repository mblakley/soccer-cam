...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Process a directory with NTFY integration")
    parser.add_argument("directory", help="Directory name to process (e.g., 2025.06.14-10.37.25)")
    parser.add_argument("--force", action="store_true", help="Force processing even if match_info is already populated")
