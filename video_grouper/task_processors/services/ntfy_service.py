...
class NtfyService:
    ...
    def _load_state(self) -> None:
        ...
        try:
            ...
            logger.debug(f"NTFY service loaded state: {len(self._pending_inputs)} pending inputs, "
    ...
    def mark_waiting_for_input(self, group_dir: str, input_type: str, metadata: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    async def request_team_info(self, group_dir: str, combined_video_path: str, 
                               existing_info: Optional[Dict[str, str]] = None, force: bool = False) -> bool:
        """
        ...
        try:
            ...
            self.mark_waiting_for_input(group_dir, 'team_info', {
    ...
    async def request_game_times(self, group_dir: str, combined_video_path: str, force: bool = False) -> bool:
        """
        ...
        try:
            ...
            if match_info and match_info.start_time_offset:
                await self.ntfy_api.ask_game_end_time(combined_video_path, group_dir, match_info.start_time_offset)
            
            # Mark as waiting for input
            self.mark_waiting_for_input(group_dir, 'game_times', {
                'combined_video_path': combined_video_path
            })
    ...
    async def process_combined_directory(self, group_dir: str, combined_video_path: str, force: bool = False) -> bool:
        """
        ...
        team_info_sent = await self.request_team_info(group_dir, combined_video_path, existing_info, force)
        
        # Request game times
        game_times_sent = await self.request_game_times(group_dir, combined_video_path, force)
