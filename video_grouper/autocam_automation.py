...
AUTOCAM_EXE_PATH = r"C:\Users\markb\AppData\Local\Programs\Once.Autocam\Once.Autocam.exe"
...
def run_autocam_on_file(input_path: str, output_path: str) -> bool:
    ...
    try:
        ...
        main_window.child_window(title="Source:", control_type="Edit").set_text(input_path)
        main_window.child_window(title="Destination:", control_type="Edit").set_text(output_path)
        logger.info("Set source and destination paths.")

        # Handle Zoom Settings
        main_window.child_window(title="Zoom Settings", control_type="Pane").click_input()
        ...
        field_marking_window.child_window(title="Apply Settings", control_type="Pane").click_input()
        ...
        main_window.child_window(title="Start Processing", control_type="Pane").click_input()
