...
def get_state_file_path(group_dir: str) -> str:
    ...
    """
    return os.path.join(group_dir, "state.json")


def get_combined_video_path(group_dir: str) -> str:
    ...
    """
    return os.path.join(group_dir, "combined.mp4")


def get_match_info_path(group_dir: str) -> str:
    ...
    """
    return os.path.join(group_dir, "match_info.ini")


def get_file_list_path(group_dir: str) -> str:
    ...
    """
    return os.path.join(group_dir, "filelist.txt")


def get_trimmed_video_path(group_dir: str, match_info) -> str:
    """
